...
import com.thezayin.editor.textMode.bottomToolbarExtension.fontFamilyOptions.FontItem
...
object FontUtils {
    ...
    val greyQoFontFamily = FontFamily(Font(R.font.grey_qo_regular, FontWeight.Normal))
    val matemasieFontFamily = FontFamily(Font(R.font.matemasie_regular, FontWeight.Bold))
    val newAmsterdamFontFamily = FontFamily(Font(R.font.new_amsterdam_regular, FontWeight.Bold))
    ...
    fun getFontItems(): List<FontItem> {
        val fontSet = arrayListOf(DefaultFontFamily.getFontItem())
        ...
        fontSet.add(newAmsterdamFontFamily.getFontItem())
        fontSet.add(oswaldFontFamily.getFontItem())
        fontSet.add(montserratFontFamily.getFontItem())
        fontSet.add(matemasieFontFamily.getFontItem())
